...
//  Seal
//
//  THE 1,024 WORDS A TREZOR SHAMIR BACKUP SHARE IS MADE OF.
//
//  BIP39English.swift covers the phrase most wallets use. Trezor's Shamir
//  Backup (SatoshiLabs Improvement Proposal 39) uses a different, shorter
//  list, and a share is 20 or 33 of these words. "academic" is the first
//  word on this list and is not on the other one, which is exactly how
//  this file came to exist: a tester typed a Trezor share into the letter
//  and Seal said nothing.
//
//  Public domain. Generated from the upstream wordlist.txt in the
//  satoshilabs/slips repository; the SHA-256 of that copy was
//  bcc4555340332d169718aed8bf31dd9d5248cb7da6e5d355140ef4f1e601eec3.
//  A plain Swift file so it joins the target with no project change.
let slip39English: Set<String> = [
