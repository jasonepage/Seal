...
// The rule itself (ReleasePolicy) moved to Estate/ReleasePolicy.swift, so the
// release machine and the rule can be compiled and tested without the rest of
// the model around them (tools/coretests).
